...
assert.match(build.version, /^0\.3\.27-stax-challenge\.b[a-f0-9]{12}$/);
for (const item of build.builds) {
  ...
  try {
    ...
    assert.equal(provenance.baseProductionVersion, '0.3.26');
    assert.equal(provenance.testBaseVersion, '0.3.27');
