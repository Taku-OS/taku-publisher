...
assert.match(build.version, /^0\.3\.22-stax-challenge\.b[a-f0-9]{12}$/);
for (const item of build.builds) {
  ...
  try {
    ...
    assert.equal(provenance.baseProductionVersion, '0.3.21');
    assert.equal(provenance.testBaseVersion, '0.3.22');
