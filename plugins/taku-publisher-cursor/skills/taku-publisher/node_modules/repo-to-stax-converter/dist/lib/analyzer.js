...
async function detectRepoContentSignals(repoRoot, files) {
...
function buildRisks(appType, files, pkg, signals, license) {
    ...
    if (signals.hasExternalCredentialText)
        risks.push('Credential/API key handling must be server-side or explicit BYOK');
