...
export const SUPPORTED_TYPES = ['skill'];
export const UNAVAILABLE_PUBLISH_TYPES = ['action', 'agent', 'plugin'];
export const SUPPORTED_MODES = ['create', 'update'];
export const SUPPORTED_RUNTIME_PLATFORMS = ['taku', 'codex', 'claude-code'];
