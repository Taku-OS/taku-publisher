...
export async function registerSubAppDraft(request, client) {
    ...
    await uploadArchive(client, path.join(plan.packageRoot, SUBAPP_SOURCE_ARCHIVE_FILE), sourceStoragePath);
    await uploadArchive(client, path.join(plan.packageRoot, SUBAPP_BUILD_ARCHIVE_FILE), buildStoragePath);
    await writeRegistrationState(stateFile, plan, {
...
async function uploadArchive(client, file, storagePathValue) {
