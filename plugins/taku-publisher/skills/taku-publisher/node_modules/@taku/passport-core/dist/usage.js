export function composeUsageSummary({ primary, periods, personaUsage, warnings = [], privateWorkspaceKeys = [], }) {
    const result = {
        scanned: true,
    ...
    Object.defineProperty(result, '__privateWorkspaceKeys', {
        value: Array.from(new Set(privateWorkspaceKeys.filter((value) => Boolean(value)))),
        enumerable: false,
    });
    return result;
}
