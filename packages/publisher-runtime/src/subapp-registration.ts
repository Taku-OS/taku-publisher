...
function normalizeRegistrationMetadata(value: JsonObject): JsonObject {
  ...
  const flowchartIntro = catalogValue.flowchartIntro ?? catalogValue.flowchart_intro;
  const flowchartIntroI18n = catalogValue.flowchartIntroI18n ?? catalogValue.flowchart_intro_i18n;
  if (flowchartIntro !== undefined && flowchartIntro !== null) {
    catalog.flowchartIntro = requireObject(flowchartIntro, 'catalog.flowchartIntro');
  }
  if (flowchartIntroI18n !== undefined && flowchartIntroI18n !== null) {
    catalog.flowchartIntroI18n = requireObject(
      flowchartIntroI18n,
      'catalog.flowchartIntroI18n',
    );
  }
