...
`;
  ...
  assert.match(String(challengeResult.message), /review and publishing/);
  assert.match(String(challengeResult.message), /creating a Taku App/);
  assert.match(String(challengeResult.message), /campaign rewards/);
  assert.match(String(challengeResult.message), /does not publish it/);
  assert.match(String(challengeResult.message), /final public release still requires your confirmation/);
